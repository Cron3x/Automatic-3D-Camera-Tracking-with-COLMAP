...
Its importent to note that this script is currently written for *COLMAP 3.13.0*, some features might change in the future so functionality can not be guaranteed.
Older versions of the script can be found in the release section

- v1.2.0: Colmap 3.13.0 + Glomap 1.2.0
